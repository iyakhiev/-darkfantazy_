...
let bot = {
	...
	picture_class: '._cmdpi:eq(1) ._mck9w',
	open_handler_class: '._si7dy',
	close_handler_class: '._dcj9f',
	like_handler_class: '.coreSpriteHeartOpen',

	libraries_active: false,
	...
	start: function () {
		...
		self.paused = false;
		if (!self.libraries_active) self.libraries();
		self.elements = $(self.picture_class);

		if (self.current_ind < self.elements.length + 1) {
			async.series({
				open: function (callback) {
					let r = 2500 + Math.random() * (5000 - 2500);
					console.log('open', self.current_ind, r);
					setTimeout(function () {
						if (self.luck('open_picture')) {
							$.ajax({
								url: 'https://www.instagram.com' + $(self.picture_class).eq(self.current_ind).children().attr('href'),
								type: "HEAD",
								error: function () {
									callback(new Error());
								},
								success: function () {
									$(self.picture_class).eq(self.current_ind).children().attr('href', '');
									$(self.picture_class).eq(self.current_ind).find(self.open_handler_class).click();
				...
				like: function (callback) {
					let r = 2500 + Math.random() * (7000 - 2500);
					console.log('like', self.current_ind, r);
					setTimeout(function () {
						if (self.luck('like')) {
							$(self.like_handler_class).click();
				...
				close: function (callback) {
					let r = 2500 + Math.random() * (5000 - 2500);
					console.log('close', self.current_ind, r);
					setTimeout(function () {
						$(self.close_handler_class).click();

						callback(null);
					}, r);
				}
			}, function (err, results) {
				//console.log('finish', self.current_ind, err, results);

				console.log('/////////// elements:', self.elements.length);
				console.log('///////////   opened:', self.opened);
				console.log('///////////    liked:', self.liked);
	...
	libraries: () => {
		bot.libraries_active =  true;
		
		(function (e, undefined) {
			var t, n, r = typeof undefined, i = e.location, o = e.document, s = o.documentElement, a = e.jQuery,
				u = e.$, l = {}, c = [], p = "2.0.3", f = c.concat, h = c.push, d = c.slice, g = c.indexOf,
				m = l.toString, y = l.hasOwnProperty, v = p.trim, x = function (e, n) {
			...
			t = x(o), function (e, undefined) {
				var t, n, r, i, o, s, a, u, l, c, p, f, h, d, g, m, y, v = "sizzle" + -new Date, b = e.document, w = 0,
					T = 0, C = st(), k = st(), N = st(), E = !1, S = function (e, t) {
						return e === t ? (E = !0, 0) : 0
			...
			var vt, xt, bt = /^(none|table(?!-c[ea]).+)/, wt = /^margin/, Tt = RegExp("^(" + b + ")(.*)$", "i"),
				Ct = RegExp("^(" + b + ")(?!px)[a-z%]+$", "i"), kt = RegExp("^([+-])=(" + b + ")", "i"),
				Nt = {BODY: "block"}, Et = {position: "absolute", visibility: "hidden", display: "block"},
				St = {letterSpacing: 0, fontWeight: 400}, jt = ["Top", "Right", "Bottom", "Left"],
				Dt = ["Webkit", "O", "Moz", "ms"];
			...
			x.fn.load = function (e, t, n) {
				...
				ajax: function (e, t) {
					...
					var n, r, i, o, s, a, u, l, c = x.ajaxSetup({}, t), p = c.context || c,
						...
						d = x.Callbacks("once memory"), g = c.statusCode || {}, m = {}, y = {}, v = 0, b = "canceled",
						T = {
			...
			var xn, bn, wn = /^(?:toggle|show|hide)$/, Tn = RegExp("^(?:([+-])=|)(" + b + ")([a-z%]*)$", "i"),
				Cn = /queueHooks$/, kn = [An], Nn = {
					"*": [function (e, t) {
						var n = this.createTween(e, t), r = n.cur(), i = Tn.exec(t),
			...
			function jn(e, t, n) {
				var r, i, o = 0, s = kn.length, a = x.Deferred().always(function () {
					...
					if (i)return !1;
					var t = xn || En(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0,
			...
			x.Tween = Ln, Ln.prototype = {
				...
				fadeTo: function (e, t, n, r) {
					...
					return e !== !1 && (e = e || "fx"), this.each(function () {
						var t, n = q.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = x.timers,
							s = r ? r.length : 0;
		...
		!function (n, t) {
			...
			function l(n) {
				return function (e) {
					var r = t(arguments, 1), u = it(function (t, r) {
						var u = this;
			...
			function s(n) {
				...
				var u = mt.call(n);
				return r && (t ? n[gt] = e : delete n[gt]), u
			}
			...
			function x(n, t) {
				var e = Pt(n), r = !e && zt(n), u = !e && !r && $t(n), o = !e && !r && !u && Le(n),
					i = e || r || u || o, c = i ? b(n.length, String) : [], f = c.length;
				for (var a in n)!t && !we.call(n, a) || i && ("length" == a || u && ("offset" == a || "parent" == a) || o && ("buffer" == a || "byteLength" == a || "byteOffset" == a) || L(a, f)) || c.push(a);
				return c
			}

			function E(n) {
				var t = n && n.constructor, e = "function" == typeof t && t.prototype || xe;
				return n === e
			}
			...
			function T(n) {
				if (!E(n))return Ee(n);
				var t = [];
				for (var e in Object(n))Te.call(n, e) && "constructor" != e && t.push(e);
				return t
			}
				...
				return function (t, e, r) {
					function u(n, t) {
						if (f -= 1, n) c = !0, r(n); else {
							if (t === Tt || c && f <= 0)return c = !0, r(null);
							o()
						}
					}
			...
			function an(n, t, e) {
				if (n = fn(n), n && (e || void 0 === t))return n.replace(yr, "");
				if (!n || !(t = Y(t)))return n;
				var r = cn(n), u = cn(t), o = en(r, u), i = tn(r, u) + 1;
			...
			function sn(n, t) {
				...
				N(n, function (n, t) {
					...
					var u, o = f(n), i = !o && 1 === n.length || o && 0 === n.length;
					if (Pt(n)) u = n.slice(0, -1), n = n[n.length - 1], e[t] = u.concat(u.length > 0 ? r : n); else if (i) e[t] = n; else {
			...
			function yn(n, t, e) {
				function r(n, t, e) {
					...
					if (l.started = !0, Pt(n) || (n = [n]), 0 === n.length && l.idle())return at(function () {
						l.drain()
					});
					for (var r = 0, u = n.length; r < u; r++) {
						var o = {data: n[r], callback: e || m};
			...
			function Hn(n, t, e) {
				...
				var o = 5, i = 0, c = {times: o, intervalFunc: Gn(i)};
			...
			var ot, it = function (n) {
				...
				ft = "object" == typeof process && "function" == typeof process.nextTick;
			ot = ct ? setImmediate : ft ? process.nextTick : r;
			var at = u(ot), lt = "function" == typeof Symbol,
				st = "object" == typeof global && global && global.Object === Object && global,
				pt = "object" == typeof self && self && self.Object === Object && self,
				ht = st || pt || Function("return this")(), yt = ht.Symbol, vt = Object.prototype,
				dt = vt.hasOwnProperty, mt = vt.toString, gt = yt ? yt.toStringTag : void 0, bt = Object.prototype,
				jt = bt.toString, St = "[object Null]", kt = "[object Undefined]", Lt = yt ? yt.toStringTag : void 0,
				Ot = "[object AsyncFunction]", wt = "[object Function]", xt = "[object GeneratorFunction]",
				Et = "[object Proxy]", At = 9007199254740991, Tt = {},
				Bt = "function" == typeof Symbol && Symbol.iterator, Ft = function (n) {
					return Bt && n[Bt] && n[Bt]()
				}, It = "[object Arguments]", _t = Object.prototype, Mt = _t.hasOwnProperty, Ut = _t.propertyIsEnumerable,
				zt = S(function () {
					return arguments
				}()) ? S : function (n) {
					return j(n) && Mt.call(n, "callee") && !Ut.call(n, "callee")
				}, Pt = Array.isArray, Vt = "object" == typeof n && n && !n.nodeType && n,
				qt = Vt && "object" == typeof module && module && !module.nodeType && module,
				Dt = qt && qt.exports === Vt, Rt = Dt ? ht.Buffer : void 0, Ct = Rt ? Rt.isBuffer : void 0,
				$t = Ct || k, Wt = 9007199254740991, Nt = /^(?:0|[1-9]\d*)$/, Qt = "[object Arguments]",
				Gt = "[object Array]", Ht = "[object Boolean]", Jt = "[object Date]", Kt = "[object Error]",
				Xt = "[object Function]", Yt = "[object Map]", Zt = "[object Number]", ne = "[object Object]",
				te = "[object RegExp]", ee = "[object Set]", re = "[object String]", ue = "[object WeakMap]",
				oe = "[object ArrayBuffer]", ie = "[object DataView]", ce = "[object Float32Array]",
				fe = "[object Float64Array]", ae = "[object Int8Array]", le = "[object Int16Array]",
				se = "[object Int32Array]", pe = "[object Uint8Array]", he = "[object Uint8ClampedArray]",
				ye = "[object Uint16Array]", ve = "[object Uint32Array]", de = {};
			de[ce] = de[fe] = de[ae] = de[le] = de[se] = de[pe] = de[he] = de[ye] = de[ve] = !0, de[Qt] = de[Gt] = de[oe] = de[Ht] = de[ie] = de[Jt] = de[Kt] = de[Xt] = de[Yt] = de[Zt] = de[ne] = de[te] = de[ee] = de[re] = de[ue] = !1;
			var me = "object" == typeof n && n && !n.nodeType && n,
				ge = me && "object" == typeof module && module && !module.nodeType && module,
				be = ge && ge.exports === me, je = be && st.process, Se = function () {
					try {
						return je && je.binding("util")
					} catch (n) {
					}
				}(), ke = Se && Se.isTypedArray, Le = ke ? w(ke) : O, Oe = Object.prototype, we = Oe.hasOwnProperty,
				xe = Object.prototype, Ee = A(Object.keys, Object), Ae = Object.prototype, Te = Ae.hasOwnProperty,
				Be = V(P, 1 / 0), Fe = function (n, t, e) {
					var r = d(n) ? q : Be;
					r(n, a(t), e)
				}, Ie = D(R), _e = l(Ie), Me = C(R), Ue = V(Me, 1), ze = l(Ue), Pe = function (n) {
					var e = t(arguments, 1);
					return function () {
						var r = t(arguments);
						return n.apply(null, e.concat(r))
					}
				}, Ve = W(), qe = function (n, e, r) {
					function u(n, t) {
						j.push(function () {
							f(n, t)
						})
				...
				}, De = "[object Symbol]", Re = 1 / 0, Ce = yt ? yt.prototype : void 0, $e = Ce ? Ce.toString : void 0,
				We = "\\ud800-\\udfff", Ne = "\\u0300-\\u036f\\ufe20-\\ufe23", Qe = "\\u20d0-\\u20f0",
				Ge = "\\ufe0e\\ufe0f", He = "\\u200d", Je = RegExp("[" + He + We + Ne + Qe + Ge + "]"),
				Ke = "\\ud800-\\udfff", Xe = "\\u0300-\\u036f\\ufe20-\\ufe23", Ye = "\\u20d0-\\u20f0",
				Ze = "\\ufe0e\\ufe0f", nr = "[" + Ke + "]", tr = "[" + Xe + Ye + "]", er = "\\ud83c[\\udffb-\\udfff]",
				rr = "(?:" + tr + "|" + er + ")", ur = "[^" + Ke + "]", or = "(?:\\ud83c[\\udde6-\\uddff]){2}",
				ir = "[\\ud800-\\udbff][\\udc00-\\udfff]", cr = "\\u200d", fr = rr + "?", ar = "[" + Ze + "]?",
				lr = "(?:" + cr + "(?:" + [ur, or, ir].join("|") + ")" + ar + fr + ")*", sr = ar + fr + lr,
				pr = "(?:" + [ur + tr + "?", tr, or, ir, nr].join("|") + ")",
				hr = RegExp(er + "(?=" + er + ")|" + pr + sr, "g"), yr = /^\s+|\s+$/g,
				vr = /^(?:async\s+)?(function)?\s*[^\(]*\(\s*([^\)]*)\)/m, dr = /,/, mr = /(=.+)?(\s*)$/,
				gr = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm;
			...
			var br, jr = V(P, 1), Sr = function () {
					return mn.apply(null, t(arguments).reverse())
				}, kr = Array.prototype.concat, Lr = function (n, e, r, u) {
					u = u || m;
					var o = a(r);
					Me(n, e, function (n, e) {
						o(n, function (n) {
						...
						for (var e = [], r = 0; r < t.length; r++)t[r] && (e = kr.apply(e, t[r]));
						return u(n, e)
					})
				}, Or = V(Lr, 1 / 0), wr = V(Lr, 1), xr = function () {
					var n = t(arguments), e = [null].concat(n);
					return function () {
						var n = arguments[arguments.length - 1];
						return n.apply(this, e)
					}
				}, Er = D(bn(gn, jn)), Ar = C(bn(gn, jn)), Tr = V(Ar, 1), Br = Sn("dir"), Fr = V(An, 1), Ir = D(bn(Bn, Bn)),
				_r = C(bn(Bn, Bn)), Mr = V(_r, 1), Ur = D(Mn), zr = C(Mn), Pr = V(zr, 1), Vr = function (n, t, e, r) {
					r = r || m;
					var u = a(e);
					Me(n, t, function (n, t) {
						u(n, function (e, r) {
				...
				}, qr = V(Vr, 1 / 0), Dr = V(Vr, 1), Rr = Sn("log"), Cr = V(zn, 1 / 0), $r = V(zn, 1);
			br = ft ? process.nextTick : ct ? setImmediate : r;
			var Wr = u(br), Nr = function (n, t) {
					var e = a(n);
					...
					return e.push = function (n, t, r) {
						...
						if (e.started = !0, Pt(n) || (n = [n]), 0 === n.length)return at(function () {
							e.drain()
						});
						t = t || 0;
				...
				}, Gr = D(Nn), Hr = C(Nn), Jr = V(Hr, 1), Kr = function (n, t) {
					t || (t = n, n = null);
					var e = a(t);
					return it(function (t, r) {
						function u(n) {
				...
				}, Xr = D(bn(Boolean, gn)), Yr = C(bn(Boolean, gn)), Zr = V(Yr, 1), nu = Math.ceil, tu = Math.max,
				eu = V(Zn, 1 / 0), ru = V(Zn, 1), uu = function (n, e) {
					function r(t) {
						var e = a(n[o++]);
